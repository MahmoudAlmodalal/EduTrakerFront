...
import { LayoutDashboard, Users, Briefcase, Activity, Settings, HelpCircle, School, GraduationCap, ClipboardList, MessageSquare, LogOut } from 'lucide-react';
        ...
        <aside className={`${styles.sidebar} ${isOpen ? styles.open : styles.closed}`}>
            ...
            <div className={styles.footer}>
                <button 
                    ...
                    style={{ width: '100%', border: 'none', background: 'transparent', cursor: 'pointer', marginBottom: '1rem', color: 'var(--text-color)' }}
                >
                    <LogOut size={20} />
                    <span className={styles.linkText} style={{ marginLeft: '12px' }}>Logout</span>
                </button>
