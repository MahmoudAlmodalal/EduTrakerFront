                            ...
                            filteredItems.map(notif => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        cursor: 'pointer',
                                        background: selectedNotification?.id === notif.id ? 'rgba(79, 70, 229, 0.1)' : (notif.read ? 'var(--sec-surface)' : 'var(--sec-border)'),
                                        borderLeft: !notif.read ? '4px solid var(--sec-primary)' : (selectedNotification?.id === notif.id ? '4px solid var(--sec-border)' : 'none')
                                    }}
                                >
                    ...
                    {activeTab === 'notifications' ? (
                        selectedNotification ? (
                            <div style={{ padding: '2rem' }}>
                                <div style={{ borderBottom: '1px solid var(--sec-border)', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                                    <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--sec-text-main)', marginBottom: '0.5rem' }}>
                                        {selectedNotification.title}
                                    </h2>
                                    <span style={{ fontSize: '0.875rem', color: 'var(--sec-text-muted)' }}>
                                        {selectedNotification.time}
                                    </span>
                                </div>
                                <div style={{ fontSize: '1.1rem', lineHeight: '1.6', color: 'var(--sec-text-main)' }}>
                            ...
                            <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--sec-text-muted)', marginTop: '3rem' }}>
                                ...
                                <p>Select a notification from the list to view its contents.</p>
                            </div>
                        )
                    ) : selectedMessage ? (
                        <>
