...
const StudentSubjects = () => {
    ...
    const handleDownload = (material) => {
        ...
        // Placeholder for actual download logic (e.g., API call to get file URL)
        alert(`Simulating download for: ${material.title}`);
    };

    const handleUpload = (assignment) => {
        console.log('Opening upload portal for assignment:', assignment.title);
        // Placeholder for actual upload logic (e.g., opening a file dialog)
        alert(`Simulating upload for: ${assignment.title}`);
    };
                                    ...
                                    <div key={assignment.id} className="p-4 bg-slate-50 rounded-lg border border-slate-100">
                                        ...
                                        {assignment.status !== 'submitted' && (
                                            <div className="flex gap-2">
                                                <button
                                                    className="flex-1 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded transition-colors flex items-center justify-center gap-2"
